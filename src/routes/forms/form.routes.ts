...
//columns
router.get(
  "/templates/:templateId/sections/:sectionId/columns",
  getTemplateColumns,
);
...
router.post(
  "/:documentId/sections/:sectionId/rows",
  createEvaluationSectionRow,
);
router.put(
  "/:documentId/sections/:sectionId/rows/:rowId",
  updateEvaluationSectionRow,
);
router.delete(
  "/:documentId/sections/:sectionId/rows/:rowId",
...
//columns
router.get(
  "/:documentId/sections/:sectionId/columns",
  getEvaluationSectionColumns,
);
router.post(
  "/:documentId/sections/:sectionId/columns",
...
router.put(
  "/:documentId/sections/:sectionId/columns/:columnId",
  updateEvaluationSectionColumn,
);
router.delete(
  "/:documentId/sections/:sectionId/columns/:columnId",
